...
import imgprofile from "../image/perfil.png"
    ...
    <>
      <section className="profile">
        ...
        <button onClick={onAddPlaceClick} className="button profile__button-add opacursor abrir">
          <img src={addImage}  alt="simbolo de adição" className="button__icon"/>
        </button>
      </section>
      <ul className="cards">
      {cards.map((card) => (
      ...
      <section className="popup popup_delete">
          <div className="popup__container popup__container_delete">
            <button type="button" className="popup__close-icon">
              <img className="popup__close-icon-img" src="./images/close-icon.png" alt="ìcone para fechar o pop-up"/>
            </button>
